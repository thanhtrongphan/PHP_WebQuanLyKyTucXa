...
<div class="form-group">
    ...
    <input type="number" class="form-control" id="slots" name="slots" min="1" step="1" value="{{$data['room_list']->slots}}">
</div>
<div class="form-group">
    <label for="price">Price:</label>
    <input type="number" class="form-control" id="price" name="price" min="1" step="1" value="{{$data['room_list']->price}}">
</div>
